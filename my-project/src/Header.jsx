...
function Header() {
    const { isDarkMode, toggleMode, activeButton, handleClick } = useHeader();
    ...
    return (
        <>
            <div className={`flex justify-end items-center p-4 ${isDarkMode ? 'bg-[#FFFFFF]' : 'bg-[#252128]'}`}>
                <div className="flex items-center space-x-2">
                    ...
                    <span className="font-inter text-[15px] font-bold leading-[18.15px] text-[#777777]">
                        <span className="text-blue-500">TÜRKÇE</span>
                        <span>'YE GEÇ</span>
                    </span>
                </div>
            </div>
            <div className={`flex justify-between items-center p-4 ${isDarkMode ? 'bg-[#FFFFFF]' : 'bg-[#252128]'}`}>
                ...
                <div className="flex items-center">
                    <div className="w-12 h-12 bg-[#EEEBFF] rounded-full flex items-center justify-center transform rotate-[22deg]">
