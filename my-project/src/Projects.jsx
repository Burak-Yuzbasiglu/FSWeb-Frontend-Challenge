            ...
            <div className="flex justify-between">
                <div className="max-w-xs">
                    ...
                    <p className={`mt-4 mb-10 font-inter text-xs font-normal text-left ${!isDarkMode ? 'text-white' : 'text-gray-600'} mb-4`}>
                        {!isTurkish ? 'Kullanıcılarınızın hangi çerezleri kabul edeceğini veya reddedeceğini seçmesine olanak tanıyan basit, özelleştirilebilir, minimal kurulumlu bir çerez eklentisi. Bu, vanilya JS, SCSS ve Parcel Bundler ile oluşturulmuştur ve bir NPM paketi olarak mevcuttur ve git deposu, kod ve temalarda her türlü özelleştirmeyi mümkün kılar.' : 'A simple, customizable, minimal setup cookie plugin that allows your users to select which cookies to accept or decline. This was created with vanilla JS, SCSS and Parcel Bundler and is available as a NPM package and the git repository makes any type of customization to code and themes possible.'}
                    </p>
                    <div className="flex">
                    ...
                    <div className="flex mt-4">
                        <span className={`font-inter text-sm font-semibold text-left text-indigo-700 mr-52 border-b border-[#3730A3] mb-4 ${!isDarkMode ? 'text-white' : 'text-gray-700'}`}>
                            {!isTurkish ? 'Github' : 'Github'}
                        </span>
                        <span className={`font-inter text-sm font-semibold text-left text-indigo-700 border-b border-[#3730A3] mb-4 ${!isDarkMode ? 'text-white' : 'text-gray-700'}`}>
